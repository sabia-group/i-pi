...
class Friction:
    ...
    def __init__(
        ...
        self._ffric_nm = depend_value(
            name="ffric_nm", func=self.get_ffric_nm, dependencies=[self._friction_coupling_nm])
    ...
    def get_friction_coupling_nm(self):
        ...
        if self.position_dependent:
            raise NotImplementedError("The calculation of friction coupling for position-dependent diffusion coefficients is not implemented.")
        else:
