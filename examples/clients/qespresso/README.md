...
<<<<<<< HEAD:examples/qespresso/README
PW:=/home/elia/Google-Drive/google-personal/q-e/bin/pw.x 
=======
```bash
PW:=~/bin/pw.x 
```
>>>>>>> 116dc11aeab92e3a5f290a3eca4dc3c91fcb2540:examples/clients/qespresso/README.md
